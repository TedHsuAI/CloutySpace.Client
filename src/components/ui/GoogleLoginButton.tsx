...
const GoogleLoginButton: FC<GoogleLoginButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2 rounded-full border border-[#75707a] py-2 px-4 text-sm shadow hover:bg-[#f4f4f4] transition cursor-pointer"
    >
      {/* 彩色 Google SVG Icon */}
      <svg
        className="w-5 h-5"
